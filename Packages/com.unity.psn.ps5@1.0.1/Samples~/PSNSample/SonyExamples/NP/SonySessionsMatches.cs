...
namespace PSNSample
{
    ...
    public partial class SonySessions : IScreen
    {
        ...
        void DoRefreshButtons(Int32 currentUserId, Match match)
        {
            ...
            if (m_MenuSessions.AddItem("Update Match Status (OnHold)", $"Update the match status to OnHold. {matchId}", match != null))
            {
            ...
            if (m_MenuSessions.AddItem("Update Match Details (ExpirationTime)", $"Increase match experation time by 30 seconds. {matchId}", match != null))
            {
        ...
        void DoScoreButton(Int32 currentUserId, Match match)
        {
            ...
            if (m_MenuSessions.AddItem("Set Match Results", $"Set the match scores. {matchId}", match != null))
            {
        ...
        AsyncOp GetMatchDetailRequest(Int32 currentUserId, Match match)
        {
        ...
        void OutputMatchDetail(MatchRequests.RetrievedMatchDetail matchDetail)
        {
            if (matchDetail == null)
            {
