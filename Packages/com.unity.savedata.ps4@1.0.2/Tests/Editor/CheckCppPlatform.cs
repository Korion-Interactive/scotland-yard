...
public class CheckCppPlatform
{
    ...
    [TestCase("com.unity.savedata.ps4", BuildTarget.PS4)]
    [Test]
    public void CheckCppMarkedForCorrectPlatforms(string packageName, params BuildTarget[] allowedTargets)
    {
        var pluginImporter = AssetImporter.GetAtPath($"Packages/{packageName}/Plugins/PS4/Source/{packageName}_preprocessed.cpp") as PluginImporter;
