...
namespace Sony
{
    namespace PS4
    {
        ...
        {
            /// <summary>
            /// Notification called once backup, after unmounting a mountpoint, has been completed. See <see cref="Mounting.Unmount"/> 
            /// </summary>
            public class UnmountWithBackupNotification : ResponseBase
            {
                ...
                /// <summary>
                /// User Id that made the unmount request
                /// </summary>
                public Int32 UserId
                {
                ...
                /// <summary>
                /// Savedata directory name that was backed up
                /// </summary>
            ...
            /// <summary>
            /// Notification when a savedata directory has been backed up. See <see cref="Backups.Backup"/> 
            /// </summary>
            public class BackupNotification : ResponseBase
            {
                ...
                /// <summary>
                /// User Id that made the backup request
                /// </summary>
                public Int32 UserId
                {
                    get { ThrowExceptionIfLocked(); return userId; }
