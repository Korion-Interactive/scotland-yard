        ...
        namespace SaveData
        {
            ...
            internal class MemoryBuffer
            {
                ...
                public void CheckMarker(BufferIntegrityChecks value)
                {
                    ...
                    throw new SaveDataException("MemoryBuffer - CheckMarker error - Expecting " + value.ToString());
                }
                ...
                public void CheckBufferOverflow(string method)
                {
                    ...
                    {
                        throw new SaveDataException("MemoryBuffer - Overflow error detected. (" + method + ") (" + bytesRead + "," + rawBuffer.size + ")");
                    }
                }
