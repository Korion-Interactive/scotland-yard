...
public class SaveDataStartupWindow : EditorWindow
{
    ...
    void OnGUI ()
	{
		...
		EditorStyles.label.fontStyle = standardFontStyle;
		EditorGUILayout.LabelField("Setup instructions for the sample and plugin usage can be found in Editor/SaveData_Readme.txt.");
		EditorGUILayout.Space();

		EditorStyles.label.fontStyle = FontStyle.Bold;
		EditorGUILayout.LabelField("Source Code");
		EditorStyles.label.fontStyle = standardFontStyle;
		EditorGUILayout.LabelField("All source code for the native (C++) included in the project. The source code and Visual Studio solutions can be found inside Source~/");
