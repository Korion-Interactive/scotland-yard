...
class User
{
    public static int GetActiveUserId
    {
        get
        {
            ...
            {
                OnScreenLog.AddError("User.GetActiveUserId : Active Gamepad is null. Must wait until the gamepad system has had time to initialise correctly.");
            }
    ...
    public static void Initialise(GamePad[] gamePads)
    {
