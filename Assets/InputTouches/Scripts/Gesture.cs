...
public class Gesture : MonoBehaviour {
	...
	public static void SetMultiTapFilter(bool flag){
		if(gesture!=null) gesture.enableMultiTapFilter=flag;
	}
	public static void SetMaxMultiTapCount(int val){
		if(gesture!=null) gesture.maxMultiTapCount=val;
	}
	public static void SetMaxMultiTapInterval(float val){
		if(gesture!=null) gesture.maxMultiTapInterval=val;
	}
	...
	public static void MultiTap(Tap tap){
		if(tap.fingerCount==1){
			...
			if(gesture.enableMultiTapFilter) gesture.CheckMultiTap(tap);
			...
			if(gesture.enableMultiTapFilter) gesture.CheckMFMultiTap(tap);
