...
public class UIPlayAnimation : MonoBehaviour
{
	...
	public void OnClick () { if (enabled && trigger == Trigger.OnClick) Play(true, false); }
    ...
    public static event System.Action<UIPlayAnimation> AnyAnimationStarted; // PATCH
	...
	public void Play (bool forward, bool onlyIfDifferent)
	{
		...
		{
            // PATCH START
            if (AnyAnimationStarted != null)
                AnyAnimationStarted(this);
            // PATCH END
