...
namespace FullInspector.Internal {
    ...
    /// </remarks>
    public static class ObjectModificationDetector {
        /// <summary>
        ...
        /// </summary>
        /// <param name="hadPriorData">Only useful if the return value is true. If this is false, then this is the first time that the
        /// modification detector has detected data; ie, there was no prior data for it. hasPriorData, for example, will always be
        /// false when adding a new component to a GameObject</param>
        public static bool WasModified(ISerializedObject obj, out bool hadPriorData) {
