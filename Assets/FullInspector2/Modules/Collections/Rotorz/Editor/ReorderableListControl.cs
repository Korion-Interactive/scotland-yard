...
namespace FullInspector.Rotorz.ReorderableList {
    ...
    public class ReorderableListControl {
        ...
        public ReorderableListControl() {
            containerStyle = ReorderableListGUI.defaultContainerStyle;
            removeButtonStyle = ReorderableListGUI.defaultRemoveButtonStyle;
        }
        ...
        private void CheckForAutoFocusControl(int controlID) {
            ...
            if (s_AutoFocusControlID == controlID) {
                ...
                RotorzGUIHelper.FocusTextInControl("AutoFocus_" + controlID + "_" + s_AutoFocusIndex);
                s_AutoFocusIndex = -1;
            }
        }
        ...
        private void DrawFooterControls(Rect position, int controlID, IReorderableListAdaptor adaptor) {
            if (hasAddButton) {
                Rect addButtonRect = new Rect(
                    ...
                    position.y - addButtonStyle.fixedHeight, //position.yMax - 1,
