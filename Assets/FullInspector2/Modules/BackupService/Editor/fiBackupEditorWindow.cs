...
namespace FullInspector.BackupService {
    ...
    public class fiBackupEditorWindow : EditorWindow {
        public static fiBackupEditorWindow Instance;
        ...
        public static void ShowWindow() {
            ...
            var window = EditorWindow.GetWindow<fiBackupEditorWindow>();
            window.minSize = new Vector2(100, 100);
			window.titleContent.text = "Backup";
        }
        ...
        private void OnGUI() {
            ...
            if (fiStorageManager.SerializedObjects.Count() == 0) {
                EditorGUILayout.HelpBox(
                    ...
                    support.".StripLeadingWhitespace(), MessageType.Info);
            }
